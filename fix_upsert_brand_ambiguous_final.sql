-- ============================================================================
-- SCRIPT DE CORRECTION FINALE DE L'AMBIGUÏTÉ DE COLONNE DANS UPSERT_BRAND
-- ============================================================================
-- Ce script corrige définitivement l'erreur "column reference 'id' is ambiguous"
-- ============================================================================

SELECT '=== CORRECTION FINALE DE L''AMBIGUÏTÉ DE COLONNE ===' as section;
...
BEGIN
    ...
    -- CORRECTION: Utiliser des alias explicites et des qualifications de table complètes
    RETURN QUERY
    SELECT 
        device_brands.id,
        device_brands.name,
...
-- 7. TEST DE LA FONCTION (si un utilisateur est connecté)
-- ============================================================================
...
-- 8. VÉRIFICATION DE LA DÉFINITION DE LA FONCTION
-- ============================================================================
...
-- 9. VÉRIFICATION DES TYPES DE COLONNES
-- ============================================================================
