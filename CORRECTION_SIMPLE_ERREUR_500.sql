-- CORRECTION SIMPLE - Erreur 500 lors de l'inscription
-- Ce script évite les ambiguïtés et corrige directement le problème

-- 1. SUPPRESSION DIRECTE DES TRIGGERS PROBLÉMATIQUES
...
-- 2. SUPPRESSION DIRECTE DES FONCTIONS PROBLÉMATIQUES
...
-- 3. CRÉATION DES TABLES NÉCESSAIRES
...
-- 4. CONFIGURATION RLS PERMISSIVE
...
SELECT 'CORRECTION SIMPLE APPLIQUÉE - L''inscription devrait maintenant fonctionner' as status;
