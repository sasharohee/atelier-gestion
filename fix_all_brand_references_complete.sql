-- ============================================================================
-- CORRECTION COMPLÈTE DE TOUTES LES RÉFÉRENCES AUX MARQUES
-- ============================================================================
-- Date: $(date)
...
-- Vérifier toutes les tables qui référencent device_brands
SELECT 
    tc.constraint_name,
    tc.table_name,
    kcu.column_name,
...
-- Vérifier les colonnes de toutes les tables concernées
SELECT 
    table_name,
    column_name,
    data_type,
...
DROP INDEX IF EXISTS idx_device_models_brand_id;
...
-- Vérifier toutes les colonnes concernées
SELECT 
    table_name,
    column_name,
    data_type,
...
-- 13. TEST DE CRÉATION D'UN MODÈLE AVEC LA MARQUE APPLE
-- ============================================================================
...
-- 14. VÉRIFICATION DU MODÈLE CRÉÉ
-- ============================================================================
