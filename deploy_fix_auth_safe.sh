...
# Script de déploiement sécurisé pour corriger l'authentification et RLS
echo "🔧 Correction sécurisée de l'authentification et RLS..."
...
# Appliquer la correction sécurisée
echo "📝 Application de la correction sécurisée..."
if psql "$DB_URL" -f fix_auth_and_rls_safe.sql; then
...
echo ""
print_warning "NOTE: Ce script vérifie l'existence des tables avant d'appliquer les politiques RLS."
