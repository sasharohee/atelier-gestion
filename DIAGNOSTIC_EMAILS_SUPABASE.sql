-- 📧 DIAGNOSTIC ET CORRECTION DES EMAILS SUPABASE
-- Script pour diagnostiquer pourquoi les emails ne sont pas envoyés

-- 1. DIAGNOSTIC - Vérifier la configuration des emails
SELECT 'DIAGNOSTIC: Configuration des emails Supabase' as info;
...
-- 2. DIAGNOSTIC - Vérifier les utilisateurs non confirmés
...
-- 3. DIAGNOSTIC - Vérifier tous les utilisateurs récents
...
-- 4. CORRECTION - Créer une fonction qui ne confirme PAS automatiquement
...
-- 5. TEST DE LA NOUVELLE FONCTION
...
-- 6. VÉRIFICATION - L'utilisateur test doit être non confirmé
...
-- 7. NETTOYAGE - Supprimer l'utilisateur test
