-- ============================================================================
-- CORRECTION POUR PERMETTRE LA MODIFICATION DE TOUTES LES MARQUES (SANS AUTH)
-- ============================================================================
-- Ce script peut être exécuté directement sans authentification
-- ============================================================================
...
-- 7. CRÉER LES FONCTIONS (AVEC GESTION D'ERREUR POUR AUTH)
-- ============================================================================
...
BEGIN
    ...
    IF v_user_id IS NULL THEN
        ...
        IF p_category_ids IS NOT NULL AND array_length(p_category_ids, 1) > 0 THEN
            ...
            WHERE EXISTS (SELECT 1 FROM device_categories WHERE id = unnest(p_category_ids));
        END IF;
    ELSE
