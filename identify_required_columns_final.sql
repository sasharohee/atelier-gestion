...
-- 5. Vérifier les valeurs par défaut
...
-- 6. Tester l'insertion avec seulement les colonnes obligatoires
...
-- 7. Résumé des colonnes requises
...
SELECT 
    '1. Exécuter identify_brand_column_issue.sql' as action_1,
    '2. Exécuter fix_brand_column_issue_final.sql' as action_2,
