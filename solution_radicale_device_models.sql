-- =====================================================
-- SOLUTION RADICALE DEVICE_MODELS
-- =====================================================
...
-- 2. Supprimer toutes les politiques RLS sur device_models
...
DECLARE
    ...
    v_user_id UUID;
BEGIN
    -- Obtenir le workshop_id depuis system_settings
...
-- 7. Créer une vue filtrée pour l'isolation côté application
...
SELECT 'ℹ️ L''isolation se fait maintenant via le trigger' as note;
