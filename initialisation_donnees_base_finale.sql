...
-- Script qui vérifie la structure exacte de chaque table avant insertion
...
-- 3. Créer des produits de base (si la table existe)
DO $$
DECLARE
    admin_user_id UUID;
    table_exists BOOLEAN;
...
-- 4. Afficher les statistiques des tables existantes
...
SELECT 'Initialisation finale terminée avec succès !' as status;
