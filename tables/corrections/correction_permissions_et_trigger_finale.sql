-- =====================================================
-- CORRECTION FINALE - PERMISSIONS ET TRIGGER
-- =====================================================
-- Source: dashboard
-- User: 84dbdd62-9341-4abb-aaa4-d263ae14784b
-- Date: 2025-08-25T14:45:00.000Z

-- Script de correction finale pour résoudre l'erreur 406 et le trigger
...
-- =====================================================
-- ÉTAPE 3: CRÉATION DE LA FONCTION ROBUSTE
-- =====================================================
...
DECLARE
  ...
  test_email TEXT := 'test_final_' || extract(epoch from now())::text || '@test.com';
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    NOW(),
    NOW(),
    '{"first_name": "Test", "last_name": "Final"}'
  );
...
SELECT 
  'Correction finale terminée' as status,
  'Le trigger fonctionne et les nouveaux utilisateurs seront ajoutés automatiquement' as message;
