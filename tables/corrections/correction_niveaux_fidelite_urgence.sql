-- =====================================================
-- CORRECTION URGENCE - NIVEAUX FIDÉLITÉ
-- =====================================================
-- Script d'urgence pour corriger les niveaux de fidélité
-- en désactivant temporairement les triggers problématiques
-- Date: 2025-01-23
-- =====================================================

-- 1. DÉSACTIVER TEMPORAIREMENT LES TRIGGERS PROBLÉMATIQUES
SELECT '=== DÉSACTIVATION TRIGGERS ===' as etape;

-- Désactiver les triggers sur les tables de fidélité
...
-- 2. CRÉER LES NIVEAUX DE FIDÉLITÉ
...
ALTER TABLE loyalty_points_history ENABLE TRIGGER ALL;
ALTER TABLE client_loyalty_points ENABLE TRIGGER ALL;
