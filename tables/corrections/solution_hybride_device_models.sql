-- =====================================================
-- SOLUTION HYBRIDE - DEVICE_MODELS
-- =====================================================
-- Combinaison isolation + fonctionnalité sans erreur 403
-- Date: 2025-01-23
-- =====================================================
...
-- 6. Créer des politiques hybrides (isolation + fonctionnalité)
...
-- 8. Créer un trigger robuste pour l'isolation automatique
...
-- 9. Test d'insertion et d'isolation
SELECT '=== TEST HYBRIDE ===' as etape;

-- Fonction de test hybride
DROP FUNCTION IF EXISTS test_device_models_hybride();

CREATE OR REPLACE FUNCTION test_device_models_hybride()
...
-- Exécuter le test
SELECT * FROM test_device_models_hybride();
...
SELECT '✅ Solution hybride activée' as message;
SELECT '✅ Insertion sans erreur 403' as insertion_info;
SELECT '✅ Isolation par workshop_id pour SELECT/UPDATE/DELETE' as isolation_info;
