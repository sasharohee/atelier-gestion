-- =====================================================
-- CORRECTION RLS CLIENTS ULTRA-STRICT V2
-- =====================================================
-- Script pour appliquer une isolation RLS ultra-stricte
-- sur la table clients (version corrigée)
-- Date: 2025-01-23
-- =====================================================
...
-- Supprimer toutes les politiques possibles avec IF EXISTS
...
BEGIN
    ...
    BEGIN
        INSERT INTO clients (
            ...
            'Test', 'UltraStrict', 'test.ultrastrict@example.com', '0123456789', '123 Test Street', v_user_id
