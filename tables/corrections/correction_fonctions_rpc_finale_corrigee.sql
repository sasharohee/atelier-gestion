-- 🔧 CORRECTION FONCTIONS RPC FINALE CORRIGÉE - Gestion des Contraintes
-- Script final corrigé pour corriger les fonctions RPC avec gestion des contraintes
-- Date: 2025-01-23

-- ============================================================================
-- 1. DIAGNOSTIC DES CONTRAINTES (CORRIGÉ)
-- ============================================================================

SELECT '=== DIAGNOSTIC DES CONTRAINTES (CORRIGÉ) ===' as section;

-- Vérifier les contraintes sur la table clients (version corrigée)
SELECT 
