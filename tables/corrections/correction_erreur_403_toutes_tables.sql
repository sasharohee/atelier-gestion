-- =====================================================
-- CORRECTION ERREUR 403 TOUTES LES TABLES - COMPLÈTE
-- =====================================================
-- Corrige les erreurs "new row violates row-level security policy" pour devices, repairs et services
-- Date: 2025-01-23
-- =====================================================
...
-- ============================================================================
-- PARTIE 3: CORRECTION TABLE SERVICES
-- ============================================================================

SELECT '=== DÉBUT CORRECTION SERVICES ===' as etape;
...
-- 2. Vérifier les politiques RLS actuelles pour services
SELECT '=== POLITIQUES RLS ACTUELLES SERVICES ===' as etape;
...
-- 3. Désactiver RLS temporairement sur services
SELECT '=== DÉSACTIVATION RLS SERVICES ===' as etape;

ALTER TABLE services DISABLE ROW LEVEL SECURITY;

-- 4. Supprimer toutes les politiques RLS existantes pour services
SELECT '=== NETTOYAGE POLITIQUES SERVICES ===' as etape;
...
SELECT '=== VÉRIFICATION STRUCTURE SERVICES ===' as etape;
...
-- 6. Mettre à jour les données existantes pour services
SELECT '=== MISE À JOUR DONNÉES SERVICES ===' as etape;
...
-- 7. Créer un trigger pour l'isolation automatique des services
SELECT '=== CRÉATION TRIGGER SERVICES ===' as etape;
...
-- 8. Activer RLS avec des politiques permissives pour services
SELECT '=== ACTIVATION RLS PERMISSIF SERVICES ===' as etape;
...
-- Test d'insertion pour services
SELECT '=== TEST INSERTION SERVICES ===' as etape;
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '❌ Erreur test service: %', SQLERRM;
END $$;
