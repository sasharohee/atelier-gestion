-- =====================================================
-- CORRECTION ISOLATION FONCTIONNELLE - DEVICE_MODELS
-- =====================================================
-- Objectif: Résoudre l'erreur 403 avec isolation active
-- Date: 2025-01-23
-- =====================================================
...
-- 7. Création des politiques RLS avec isolation stricte
SELECT '=== CRÉATION POLITIQUES RLS ISOLATION ===' as etape;
...
-- Politique INSERT: Permissive (le trigger définit workshop_id)
...
SELECT '✅ Isolation RLS active et fonctionnelle' as message;
