...
ALTER TABLE public.products ADD COLUMN IF NOT EXISTS min_stock_level INTEGER DEFAULT 1;
...
UPDATE public.products SET min_stock_level = 1 WHERE min_stock_level IS NULL;
