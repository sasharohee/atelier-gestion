-- =====================================================
-- DIAGNOSTIC ISOLATION CLIENTS ET APPAREILS - URGENCE
-- =====================================================
-- Objectif: Diagnostic urgent pour comprendre pourquoi l'isolation ne fonctionne pas
-- Date: 2025-01-23
-- =====================================================
...
BEGIN
    ...
    VALUES ('Test Diagnostic Urgence', 'Clients', 'test.diagnostic.urgence.clients@example.com', '333333333')
    ...
    VALUES ('Test Brand Urgence', 'Test Model Urgence', 'TESTURGENCE123')
...
SELECT 'DIAGNOSTIC URGENCE CLIENTS ET DEVICES TERMINÉ' as status;
