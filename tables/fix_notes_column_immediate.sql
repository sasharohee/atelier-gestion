-- =====================================================
-- CORRECTION IMMÉDIATE - COLONNE NOTES MANQUANTE
-- =====================================================
-- Date: 2025-01-23
-- Problème: "Could not find the 'notes' column of 'clients' in the schema cache"
-- =====================================================

-- 1. AJOUTER LA COLONNE NOTES SI MANQUANTE
DO $$
BEGIN
    IF NOT EXISTS (
...
-- 2. RAFRAÎCHIR LE CACHE POSTGREST (CRITIQUE)
NOTIFY pgrst, 'reload schema';

-- 3. ATTENDRE UN MOMENT POUR LA SYNCHRONISATION
SELECT pg_sleep(1);

-- 4. VÉRIFIER LA STRUCTURE
SELECT 
    'STRUCTURE CLIENTS' as section,
    column_name,
    data_type,
    is_nullable
