-- =====================================================
-- CORRECTION URGENCE ERREUR 500 INSCRIPTION - SIMPLIFIÉ
-- =====================================================
-- Source: dashboard
-- User: 84dbdd62-9341-4abb-aaa4-d263ae14784b
-- Date: 2025-08-25T15:10:00.000Z

-- Script de correction d'urgence simplifié pour l'erreur 500 lors de l'inscription
...
DECLARE
  ...
  test_email TEXT := 'test_500_simple_' || extract(epoch from now())::text || '@test.com';
BEGIN
  RAISE NOTICE '🧪 Test de correction erreur 500 simplifié pour: %', test_email;
...
SELECT 
  'CORRECTION ERREUR 500 SIMPLIFIÉE TERMINÉE' as status,
