-- Correction des statistiques pour le frontend
-- Ce script corrige la fonction RPC pour qu'elle retourne les bonnes clés
...
-- 3. Recréer la fonction RPC avec les bonnes clés pour le frontend
...
BEGIN
    ...
    RAISE NOTICE 'La fonction RPC utilise maintenant "inReview" (camelCase).';
    RAISE NOTICE 'Le frontend devrait maintenant afficher les statistiques.';
END $$;
