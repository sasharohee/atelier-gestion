-- RÉACTIVATION RLS FINALE - Avec les bonnes politiques d'isolation
...
-- Politique pour LECTURE (SELECT) - Permet de voir ses propres clients + clients système
...
-- Politique pour MODIFICATION (UPDATE) - Permet de modifier ses propres clients + clients système
...
-- Politique pour SUPPRESSION (DELETE) - Permet de supprimer ses propres clients + clients système
...
BEGIN
    ...
    INSERT INTO clients (
        ...
        'TEST001', '123456789', 'Note de test isolation',
        test_user_id
