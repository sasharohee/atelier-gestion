-- ============================================================================
-- SCRIPT DE CORRECTION DU TYPE ID DANS DEVICE_BRANDS AVEC GESTION DES CONTRAINTES
-- ============================================================================
-- Ce script corrige définitivement le conflit de type UUID vs TEXT
-- en gérant les contraintes de clé étrangère
-- ============================================================================

SELECT '=== CORRECTION DU TYPE ID DANS DEVICE_BRANDS AVEC CASCADE ===' as section;
...
-- 2. IDENTIFIER LES CONTRAINTES QUI DÉPENDENT DE LA CLÉ PRIMAIRE
-- ============================================================================
...
-- 4. SUPPRIMER TEMPORAIREMENT LES CONTRAINTES DE CLÉ ÉTRANGÈRE
-- ============================================================================
SELECT '=== SUPPRESSION TEMPORAIRE DES CONTRAINTES ===' as section;
...
-- 5. CORRIGER LE TYPE DE LA COLONNE ID
-- ============================================================================
...
-- 6. CORRIGER LE TYPE DE BRAND_CATEGORIES.BRAND_ID
-- ============================================================================
...
-- 7. RECRÉER LES CONTRAINTES DE CLÉ ÉTRANGÈRE
-- ============================================================================
...
-- 8. RECRÉER LES FONCTIONS RPC AVEC LES BONS TYPES
-- ============================================================================
...
SELECT '✅ Correction du type ID avec gestion des contraintes terminée avec succès' as status;
