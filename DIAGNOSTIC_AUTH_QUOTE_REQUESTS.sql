-- Diagnostic de l'authentification pour les demandes de devis
-- Ce script aide à identifier les problèmes d'authentification
...
-- 4. Vérifier les profils utilisateurs
SELECT 
    user_id,
    first_name,
    last_name,
...
-- 11. Vérifier les logs d'erreur récents (si disponibles)
...
SELECT 
    ...
    message
FROM postgres_logs 
WHERE message LIKE '%technician_custom_urls%' 
   OR message LIKE '%RLS%'
   OR message LIKE '%403%'
