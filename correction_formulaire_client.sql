-- Correction des champs manquants dans la table clients
-- Ce script s'assure que tous les champs sont correctement gérés
...
-- ========================================
-- ÉTAPE 2: CORRECTION DES CHAMPS NULL
-- ========================================
...
-- Vérifier qu'il n'y a plus de champs NULL
SELECT 
    'VÉRIFICATION: Champs NULL après correction' as section,
    'Nom société' as field,
    COUNT(*) as remaining_null_count
FROM clients WHERE company_name IS NULL OR company_name = ''
UNION ALL
SELECT 
    'VÉRIFICATION: Champs NULL après correction' as section,
    'TVA' as field,
    COUNT(*) as remaining_null_count
FROM clients WHERE vat_number IS NULL OR vat_number = ''
UNION ALL
SELECT 
    'VÉRIFICATION: Champs NULL après correction' as section,
    'SIREN' as field,
    COUNT(*) as remaining_null_count
FROM clients WHERE siren_number IS NULL OR siren_number = ''
UNION ALL
SELECT 
    'VÉRIFICATION: Champs NULL après correction' as section,
    'Code postal' as field,
    COUNT(*) as remaining_null_count
FROM clients WHERE postal_code IS NULL OR postal_code = ''
UNION ALL
SELECT 
    'VÉRIFICATION: Champs NULL après correction' as section,
    'Code comptable' as field,
    COUNT(*) as remaining_null_count
FROM clients WHERE accounting_code IS NULL OR accounting_code = ''
UNION ALL
SELECT 
    'VÉRIFICATION: Champs NULL après correction' as section,
    'Identifiant CNI' as field,
    COUNT(*) as remaining_null_count
FROM clients WHERE cni_identifier IS NULL OR cni_identifier = '';

-- ========================================
-- ÉTAPE 4: EXEMPLE DE CLIENT CORRIGÉ
-- ========================================

-- Afficher un exemple de client corrigé
SELECT 
...
SELECT 
    'RÉSUMÉ FINAL' as section,
    'Clients avec nom société' as metric,
    COUNT(*) as value
FROM clients WHERE company_name != ''
UNION ALL
SELECT 
    'RÉSUMÉ FINAL' as section,
    'Clients avec TVA' as metric,
    COUNT(*) as value
FROM clients WHERE vat_number != ''
UNION ALL
SELECT 
    'RÉSUMÉ FINAL' as section,
    'Clients avec SIREN' as metric,
    COUNT(*) as value
FROM clients WHERE siren_number != ''
UNION ALL
SELECT 
    'RÉSUMÉ FINAL' as section,
...
SELECT 
    'RÉSUMÉ FINAL' as section,
    'Clients avec code comptable' as metric,
    COUNT(*) as value
FROM clients WHERE accounting_code != ''
UNION ALL
SELECT 
    'RÉSUMÉ FINAL' as section,
    'Clients avec identifiant CNI' as metric,
    COUNT(*) as value
FROM clients WHERE cni_identifier != '';
