...
-- À exécuter après identify_brand_column_ultimate.sql
...
INSERT INTO public.device_models (
    ...
    'Test avec toutes les colonnes requises ultime',
    true
);
...
WHERE name = 'Test Complete Model Ultimate'
...
WHERE dm.name = 'Test Complete Model Ultimate'
