-- Script de diagnostic pour un utilisateur existant (version corrigée)
-- À exécuter dans l'éditeur SQL de Supabase

-- 1. Vérifier l'état complet de l'utilisateur
SELECT 
    'Etat de l''utilisateur:' as info,
    id,
    email,
    created_at,
    updated_at,
...
SELECT 
    ...
    CASE 
        ...
        ELSE 'Present dans public.users'
    END as sync_status
FROM auth.users u
