...
-- Version simplifiée pour éviter les erreurs de paramètres
...
-- 3. Créer une fonction RPC sécurisée pour la création d'utilisateurs (version simplifiée)
...
-- 6. Créer un trigger pour la création automatique de profils utilisateur
...
-- 7. Attacher le trigger à la table users
...
-- 8. Vérifier que les politiques sont en place
SELECT 
  schemaname,
  tablename,
  policyname,
