...
-- À exécuter après force_remove_trigger_ultime_final.sql
...
('Test Multiple Final 1', (SELECT id FROM public.device_brands WHERE is_active = true LIMIT 1), (SELECT id FROM public.device_categories WHERE is_active = true LIMIT 1), 'Test multiple final 1', true),
('Test Multiple Final 2', (SELECT id FROM public.device_brands WHERE is_active = true LIMIT 1), (SELECT id FROM public.device_categories WHERE is_active = true LIMIT 1), 'Test multiple final 2', true);
...
WHERE name LIKE 'Test Multiple Final%'
