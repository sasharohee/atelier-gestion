-- ============================================================================
-- CRÉATION SIMPLE DE LA TABLE DE LIAISON POUR LES CATÉGORIES DE MARQUES
-- ============================================================================
-- Date: $(date)
-- Description: Créer la table brand_categories pour permettre plusieurs catégories par marque
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.brand_categories (
    ...
    brand_id TEXT NOT NULL, -- Utiliser TEXT pour accepter les IDs hardcodés comme "1", "2", etc.
...
-- 7. FONCTION SIMPLE POUR METTRE À JOUR LES CATÉGORIES D'UNE MARQUE
-- ============================================================================
SELECT '=== CRÉATION FONCTION update_brand_categories ===' as section;
...
BEGIN
    ...
    -- Supprimer toutes les relations existantes pour cette marque et cet utilisateur
...
BEGIN
    ...
    IF v_user_id IS NOT NULL THEN
        ...
        BEGIN
            ...
            RAISE NOTICE '✅ Test réussi : Vue brand_with_categories accessible';
...
BEGIN
    ...
    RAISE NOTICE '✅ Fonction update_brand_categories créée pour gérer les catégories';
    RAISE NOTICE '✅ Support des IDs hardcodés (comme "1", "2", etc.)';
