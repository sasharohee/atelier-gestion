...
-- 5. Extraire spécifiquement les valeurs importantes
SELECT 
...
BEGIN
    ...
    RAISE NOTICE 'Vérifiez si la clé "in_review" ou "inReview" existe.';
    RAISE NOTICE 'Le frontend attend "inReview" (camelCase).';
END $$;
