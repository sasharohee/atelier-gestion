-- Script corrigé pour restaurer les données par défaut
...
-- 4. Créer quelques modèles d'exemple (sans la colonne description)
...
SELECT 
    ...
    NULL
FROM (VALUES 
    ('iPhone 15', 'Écran 6.1", A17 Pro, 128GB', '1'),
    ('Galaxy S24', 'Écran 6.2", Snapdragon 8 Gen 3, 256GB', '2'),
    ('Pixel 8', 'Écran 6.2", Tensor G3, 128GB', '3'),
    ('Surface Pro 9', 'Écran 13", Intel i7, 512GB', '4'),
    ('WH-1000XM5', 'Réduction de bruit, 30h autonomie', '5')
...
SELECT dm.name, dm.specifications, db.name as brand_name, dc.name as category_name 
